...
export const register = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            text: `Welcome to Secure-Authentication. Your account has been created with email id: ${email}`
        }
...
export const login = async (req, res) => {
    ...
    if (!email || !password) {
        return res.json({ success: false, message: 'Email and apssword are required to login' })
    }
